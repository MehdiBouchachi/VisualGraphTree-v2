    ...
    <Card>
      ...
      {dijkstraResult ? (
        ...
        <Hint>
          ...
          the step-by-step evolution of distances on the graph. You can then use
          the slider or auto play to animate the algorithm.
        </Hint>
      )}
    </Card>
  );
...
/* ========== DSATUR section component ========== */

function DsaturSection({
  graph,
  unweightedGraph,
  nodePositions,
  dsaturResult,
    ...
    <Card>
      ...
      {dsaturResult ? (
        ...
        <Hint>
          ...
          <strong>Next / Prev / Auto play</strong> to see how saturation changes
          and how colors are assigned.
        </Hint>
      )}
    </Card>
  );
...
export default function TP4PCCColor() {
  ...
  /* Shared config handler (must reset algo states) */
